...
void newResultAdd()
{
    ...
    cout<<"Bangla:";
    cin>>s1.Bangla;
    outfile<<s1.rId<<" "<<s1.classes<<" "<<s1.Biology<<" "<<s1.english<<" "<<s1.maths<<" "<<s1.science<<" "<<s1.Bangla<<endl;
    cout<<"\n**Successfully Added**\n";
    outfile.close();
    return;
...
void updateResultAdd()
{
    ...
    while(std::getline(infile, line))
    {
        ...
        if(flag==1)
        {
            ...
            cout<<"Bangla:";
            cin>>s1.Bangla;
            tempfile<<rId<<" "<<classes<<" "<<s1.Biology<<" "<<s1.english<<" "<<s1.maths<<" "<<s1.science<<" "<<s1.Bangla<<endl;
